...
local MainLink = LoadLocal and "" or "https://raw.githubusercontent.com/TDSX1/Strategies-X/main/TDS/"
...
local Patcher = loadstring(game:HttpGet(MainLink.."TDSTools/ConvertFunc.lua", true))()--loadstring(game:HttpGet("https://raw.githubusercontent.com/TDSX1/Strategies-X/main/ConvertFunc.lua", true))()
